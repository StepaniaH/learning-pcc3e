    ...
    def _update_raindrops(self):
        ...
        for raindrop in self.raindrops.copy():
            if raindrop.check_edges():
                ...
                self._create_raindrop_at_top(raindrop.rect.x)

    def _create_raindrop_at_top(self, x_position):
        """Create a raindrop at the top of the screen."""
        raindrop = Rain(self)
        raindrop.rect.x = x_position
        raindrop.rect.top = 0
